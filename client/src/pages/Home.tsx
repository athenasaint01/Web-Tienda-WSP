...
function InfiniteGalleryCarousel({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#f9f3ef] to-transparent z-10" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[#f9f3ef] to-transparent z-10" />
