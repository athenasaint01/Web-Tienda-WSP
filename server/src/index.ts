...
import thicknessesRouter from "./routes/thicknesses";
...
import adminAudiencesRouter from "./routes/admin/audiences";
import adminThicknessesRouter from "./routes/admin/thicknesses";
import adminSizesRouter from "./routes/admin/sizes";
import adminLengthsRouter from "./routes/admin/lengths";
...
app.use("/api/thicknesses", thicknessesRouter);
...
app.use("/api/admin/audiences", adminAudiencesRouter);
app.use("/api/admin/thicknesses", adminThicknessesRouter);
app.use("/api/admin/sizes", adminSizesRouter);
app.use("/api/admin/lengths", adminLengthsRouter);
